        ...
        <div className="flex flex-col items-center justify-center min-h-[75vh] w-full px-4 py-8 animate-in fade-in zoom-in duration-500 relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 w-full max-w-7xl">
                ...
                <button
                    ...
                    className="group relative overflow-hidden bg-white/80 backdrop-blur-md border-4 border-orange-100 hover:border-orange-400 p-4 sm:p-5 rounded-[32px] shadow-2xl hover:shadow-orange-100 transition-all transform hover:-translate-y-2 active:scale-95 flex flex-col items-center justify-center gap-3 cursor-pointer min-h-[200px] sm:min-h-[230px]"
                >
                    <div className="text-center w-full px-1">
                        <span className="text-xl sm:text-2xl font-black text-orange-800 tracking-tight italic block mb-2 font-display break-words">
                            {lang === 'ta' ? 'விற்பனை' : 'Sales'}
                        </span>
                        <span className="text-[10px] sm:text-xs font-bold text-gray-400 uppercase tracking-wide font-sans block leading-normal break-words">
                ...
                <button
                    ...
                    className="group relative overflow-hidden bg-white/80 backdrop-blur-md border-4 border-emerald-100 hover:border-emerald-400 p-4 sm:p-5 rounded-[32px] shadow-2xl hover:shadow-emerald-100 transition-all transform hover:-translate-y-2 active:scale-95 flex flex-col items-center justify-center gap-3 cursor-pointer min-h-[200px] sm:min-h-[230px]"
                >
                    <div className="text-center w-full px-1">
                        <span className="text-xl sm:text-2xl font-black text-emerald-800 tracking-tight italic block mb-2 font-display break-words">
                ...
                <button
                    ...
                    className="group relative overflow-hidden bg-white/80 backdrop-blur-md border-4 border-indigo-100 hover:border-indigo-400 p-4 sm:p-5 rounded-[32px] shadow-2xl hover:shadow-indigo-100 transition-all transform hover:-translate-y-2 active:scale-95 flex flex-col items-center justify-center gap-3 cursor-pointer min-h-[200px] sm:min-h-[230px]"
                >
                    <div className="text-center w-full px-1">
                        <span className="text-[18px] sm:text-2xl font-black text-indigo-800 tracking-tight italic block mb-2 font-display break-words">
                ...
                <button
                    ...
                    className="group relative overflow-hidden bg-white/80 backdrop-blur-md border-4 border-pink-100 hover:border-pink-400 p-4 sm:p-5 rounded-[32px] shadow-2xl hover:shadow-pink-100 transition-all transform hover:-translate-y-2 active:scale-95 flex flex-col items-center justify-center gap-3 cursor-pointer min-h-[200px] sm:min-h-[230px]"
                >
                    <div className="text-center w-full px-1">
                        <span className="text-xl sm:text-2xl font-black text-pink-800 tracking-tight italic block mb-2 font-display break-words">
