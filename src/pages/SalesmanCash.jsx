...
import { saveSalesmanCash, deleteSalesmanCash, subscribeToCollection, updateData } from '../utils/storage';
import { LangContext } from '../components/Layout';
import { Plus, X, Calendar, User, Trash2, CheckCircle2, Pencil } from 'lucide-react';
...
const SalesmanCash = () => {
    ...
    const handleEdit = (record) => {
        ...
        setFormData({
            ...
            openingCash: record.openingCash.toString(),
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingRecordId) {
                await updateData('salesman_cash', editingRecordId, record);
                alert('✅ Cash Issue Updated Successfully!');
            } else {
                ...
                <div style={S.modalOverlay}>
                    <div style={S.modalCard}>
                        <div style={S.modalHeader}>
                            <h3 style={S.modalTitle}>{editingRecordId ? '💰 Edit Cash Issue' : '💰 Issue Cash'}</h3>
